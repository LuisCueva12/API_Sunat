...
final class ViewComprobante extends ViewRecord
{
    ...
    {
        return [
            ComprobanteResource::accionReintentar(),
        ];
    }
    ...
    public function infolist(Schema $schema): Schema
    {
        return $schema->components([
            Section::make('Datos generales')->schema([
                TextEntry::make('tipo')->label('Tipo')->badge()->formatStateUsing(fn (string $state): string => ComprobanteResource::etiquetaTipo($state)),
                TextEntry::make('serie'),
                TextEntry::make('correlativo'),
                TextEntry::make('estado')->badge()->color(fn (string $state): string => ComprobanteResource::colorEstado($state))->formatStateUsing(fn (string $state): string => ComprobanteResource::etiquetaEstado($state)),
