...
11. **Clientes** (`modules/Clientes/`, implementado 2026-08-19 — ver §14) — entidad `Cliente` por empresa, CRUD en ambos paneles. Todavía no conectado al flujo de emisión; no reemplaza el snapshot desnormalizado en `comprobantes.receptor_*`.
