...
### clientes (`modules/Clientes/`, implementado 2026-08-19)

| Campo | Tipo | Notas |
|---|---|---|
| id | uuid | |
| empresa_id | uuid FK | |
| tipo_documento | varchar(1) | catálogo 1 SUNAT (0/1/4/6/7) |
| numero_documento | varchar(15) | UNIQUE (empresa_id, tipo_documento, numero_documento) |
